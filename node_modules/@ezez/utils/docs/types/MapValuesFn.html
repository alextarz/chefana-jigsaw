...
<li class="tsd-signature" id="__type.__type-1"><span class="tsd-signature-symbol">(</span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">S</span><span class="tsd-signature-symbol">[</span><span class="tsd-signature-symbol">keyof </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">S</span><span class="tsd-signature-symbol">]</span>, key<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">keyof </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">S</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">R</span></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>A callback function to <a href="../functions/mapValues.html">mapValues</a>. It should return new value, optionally may return exported mapValuesUnset
value to unset a property in the target the object.</p>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-0">function</span><span class="hl-1"> </span><span class="hl-2">fn</span><span class="hl-1">(</span><span class="hl-3">value</span><span class="hl-1">, </span><span class="hl-3">key</span><span class="hl-1">) { </span><span class="hl-4">return</span><span class="hl-1"> </span><span class="hl-3">value</span><span class="hl-1"> * </span><span class="hl-5">5</span><span class="hl-1">; } </span><span class="hl-6">// all properties will be multiplied</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-0">function</span><span class="hl-1"> </span><span class="hl-2">fn</span><span class="hl-1">(</span><span class="hl-3">value</span><span class="hl-1">, </span><span class="hl-3">key</span><span class="hl-1">) {</span><br/><span class="hl-1">  </span><span class="hl-4">if</span><span class="hl-1"> (</span><span class="hl-3">key</span><span class="hl-1"> === </span><span class="hl-7">&quot;name&quot;</span><span class="hl-1">) {</span><br/><span class="hl-1">    </span><span class="hl-4">return</span><span class="hl-1"> </span><span class="hl-3">mapValuesUNSET</span><span class="hl-1">;</span><br/><span class="hl-1">  }</span><br/><span class="hl-1">  </span><span class="hl-4">return</span><span class="hl-1"> </span><span class="hl-3">value</span><span class="hl-1">.</span><span class="hl-2">toUpperCase</span><span class="hl-1">();</span><br/><span class="hl-1">} </span><span class="hl-6">// will upper case all properties and filter out name property</span>
</code></pre>

<h3>Returns</h3><ul>
<li>new value of a property</li>
</ul>
</div>
...
<li>
<h5>value: <span class="tsd-signature-type" data-tsd-kind="Type parameter">S</span><span class="tsd-signature-symbol">[</span><span class="tsd-signature-symbol">keyof </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">S</span><span class="tsd-signature-symbol">]</span></h5>
<div class="tsd-comment tsd-typography"><p>property value</p>
</div></li>
<li>
<h5>key: <span class="tsd-signature-symbol">keyof </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">S</span></h5>
<div class="tsd-comment tsd-typography"><p>property name</p>
</div></li></ul></div>
...
<li class="current tsd-kind-type-alias"><a href="MapValuesFn.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Map<wbr/>Values<wbr/>Fn</a></li>
...
<li class="tsd-kind-type-alias"><a href="ThrottledFunction.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Throttled<wbr/>Function</a></li>
