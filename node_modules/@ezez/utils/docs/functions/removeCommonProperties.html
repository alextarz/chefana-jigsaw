<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>removeCommonProperties | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="removeCommonProperties.html">removeCommonProperties</a></li></ul>
<h1>Function removeCommonProperties</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures tsd-kind-function">
<li class="tsd-signature tsd-anchor-link" id="removeCommonProperties">remove<wbr/>Common<wbr/>Properties<span class="tsd-signature-symbol">(</span>source<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Obj</span>, target1<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Obj</span>, <span class="tsd-signature-symbol">...</span>targetN<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Obj</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span><a href="#removeCommonProperties" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Removes properties from all targets if they are the same as in source. It mutates the targets!
...
<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">removeCommonProperties</span><span class="hl-1">({ </span><span class="hl-3">title:</span><span class="hl-1"> </span><span class="hl-7">&quot;Hello&quot;</span><span class="hl-1">, </span><span class="hl-3">author:</span><span class="hl-1"> </span><span class="hl-7">&quot;John&quot;</span><span class="hl-1">}, { </span><span class="hl-3">title:</span><span class="hl-1"> </span><span class="hl-7">&quot;Hello 2&quot;</span><span class="hl-1">, </span><span class="hl-3">author:</span><span class="hl-1"> </span><span class="hl-7">&quot;John&quot;</span><span class="hl-1"> }, { </span><span class="hl-3">title:</span><span class="hl-1"> </span><span class="hl-7">&quot;Hello 3&quot;</span><span class="hl-1">, </span><span class="hl-3">author:</span><span class="hl-1"> </span><span class="hl-7">&quot;John&quot;</span><span class="hl-1"> });</span><br/><span class="hl-6">// targets: { title: &quot;Hello 2&quot; }, { title: &quot;Hello 3&quot; }</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">removeCommonProperties</span><span class="hl-1">({ </span><span class="hl-3">title:</span><span class="hl-1"> </span><span class="hl-7">&quot;Hello&quot;</span><span class="hl-1">, </span><span class="hl-3">author:</span><span class="hl-1"> </span><span class="hl-7">&quot;John&quot;</span><span class="hl-1">}, { </span><span class="hl-3">title:</span><span class="hl-1"> </span><span class="hl-7">&quot;Hello 2&quot;</span><span class="hl-1">, </span><span class="hl-3">author:</span><span class="hl-1"> </span><span class="hl-7">&quot;John&quot;</span><span class="hl-1"> }, { </span><span class="hl-3">title:</span><span class="hl-1"> </span><span class="hl-7">&quot;Hello 3&quot;</span><span class="hl-1">, </span><span class="hl-3">author:</span><span class="hl-1"> </span><span class="hl-7">&quot;Matt&quot;</span><span class="hl-1"> });</span><br/><span class="hl-6">// targets: { title: &quot;Hello 2&quot;, author: &quot;John&quot; }, { title: &quot;Hello 3&quot;, author: &quot;Matt&quot; }</span>
</code></pre>
</div>
...
<li>
<h5>source: <span class="tsd-signature-type">Obj</span></h5>
<div class="tsd-comment tsd-typography"><p>source object</p>
</div></li>
<li>
<h5>target1: <span class="tsd-signature-type">Obj</span></h5>
<div class="tsd-comment tsd-typography"><p>first target object (required)</p>
</div></li>
<li>
<h5><code class="tsd-tag ts-flagRest">Rest</code> <span class="tsd-signature-symbol">...</span>targetN: <span class="tsd-signature-type">Obj</span><span class="tsd-signature-symbol">[]</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/removeCommonProperties.ts#L25">removeCommonProperties.ts:25</a></li></ul></aside></li></ul></section></div>
...
<li class="current tsd-kind-function"><a href="removeCommonProperties.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-64-path"></use><use href="#icon-64-text"></use></svg>remove<wbr/>Common<wbr/>Properties</a></li>
