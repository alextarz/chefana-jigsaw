<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>isEmpty | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="isEmpty.html">isEmpty</a></li></ul>
<h1>Function isEmpty</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures tsd-kind-function">
<li class="tsd-signature tsd-anchor-link" id="isEmpty">is<wbr/>Empty<span class="tsd-signature-symbol">(</span>obj<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">unknown</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><a href="#isEmpty" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Returns true if passed argument seems to be empty.
...
<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">({}) </span><span class="hl-6">// true</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">(</span><span class="hl-5">100</span><span class="hl-1">) </span><span class="hl-6">// throws</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">([]) </span><span class="hl-6">// true</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">([</span><span class="hl-5">1</span><span class="hl-1">]) </span><span class="hl-6">// false</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">({ </span><span class="hl-3">length:</span><span class="hl-1"> </span><span class="hl-5">5</span><span class="hl-1"> }) </span><span class="hl-6">// false</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">({ </span><span class="hl-3">length:</span><span class="hl-1"> </span><span class="hl-5">0</span><span class="hl-1"> }) </span><span class="hl-6">// true</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isEmpty</span><span class="hl-1">({ </span><span class="hl-3">size:</span><span class="hl-1"> </span><span class="hl-5">0</span><span class="hl-1"> }) </span><span class="hl-6">// true</span>
</code></pre>
...
<div class="tsd-comment tsd-typography"><p>source value</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/isEmpty.ts#L28">isEmpty.ts:28</a></li></ul></aside></li></ul></section></div>
...
<li class="current tsd-kind-function"><a href="isEmpty.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-64-path"></use><use href="#icon-64-text"></use></svg>is<wbr/>Empty</a></li>
