<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>setImmutable | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li class="tsd-signature tsd-anchor-link" id="setImmutable">set<wbr/>Immutable<span class="tsd-signature-symbol">(</span>source<span class="tsd-signature-symbol">: </span><a href="../interfaces/SetImmutableSource.html" class="tsd-signature-type" data-tsd-kind="Interface">SetImmutableSource</a>, path<span class="tsd-signature-symbol">: </span><a href="../types/SetImmutablePath.html" class="tsd-signature-type" data-tsd-kind="Type alias">SetImmutablePath</a>, value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">unknown</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">unknown</span><a href="#setImmutable" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Updates the value at given path of given object. It does not mutate the object but returns a new one. If path is not
found then objects are created &quot;on the way&quot;. If non-objects are found, they are replaced with new plain objects. If
primitives are used as source they are ignored and returned value is empty object with updated value at given path.</p>
<p>This is still too dynamic in nature to get full TypeScript support. Properties are not typed, return type is unknown.
It is recommended to use <code>immutable-assign</code> package instead.</p>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">set</span><span class="hl-1">(</span><span class="hl-3">object</span><span class="hl-1">, </span><span class="hl-7">&quot;deep.property&quot;</span><span class="hl-1">, </span><span class="hl-3">value</span><span class="hl-1">)</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">set</span><span class="hl-1">(</span><span class="hl-3">object</span><span class="hl-1">, [</span><span class="hl-7">&quot;deep&quot;</span><span class="hl-1">, </span><span class="hl-7">&quot;property&quot;</span><span class="hl-1">], </span><span class="hl-3">value</span><span class="hl-1">)</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">set</span><span class="hl-1">({}, </span><span class="hl-7">&quot;deep[0].property&quot;</span><span class="hl-1">, </span><span class="hl-3">value</span><span class="hl-1">)</span><br/><span class="hl-6">// will create this structure:</span><br/><span class="hl-1">{ </span><span class="hl-7">&quot;deep[0]&quot;</span><span class="hl-1">: { </span><span class="hl-7">&quot;property&quot;</span><span class="hl-3">:</span><span class="hl-1"> </span><span class="hl-3">value</span><span class="hl-1"> }}</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">set</span><span class="hl-1">({}, </span><span class="hl-7">&quot;items.0&quot;</span><span class="hl-1">, </span><span class="hl-3">value</span><span class="hl-1">)</span><br/><span class="hl-6">// will create an object, not an array</span><br/><span class="hl-1">{ </span><span class="hl-7">&quot;items&quot;</span><span class="hl-1">: { </span><span class="hl-7">&quot;0&quot;</span><span class="hl-3">:</span><span class="hl-1"> </span><span class="hl-3">value</span><span class="hl-1"> }}</span>
</code></pre>
...
<li>
<h5>source: <a href="../interfaces/SetImmutableSource.html" class="tsd-signature-type" data-tsd-kind="Interface">SetImmutableSource</a></h5>
<div class="tsd-comment tsd-typography"><p>source object to mutate</p>
</div></li>
<li>
<h5>path: <a href="../types/SetImmutablePath.html" class="tsd-signature-type" data-tsd-kind="Type alias">SetImmutablePath</a></h5>
<div class="tsd-comment tsd-typography"><p>path where value should be stored, written as dot-separated
property names or array with property names. Use Array when your keys includes dots.</p>
</div></li>
<li>
<h5>value: <span class="tsd-signature-type">unknown</span></h5>
<div class="tsd-comment tsd-typography"><p>value to be set</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">unknown</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/setImmutable.ts#L70">setImmutable.ts:70</a></li></ul></aside></li></ul></section></div>
