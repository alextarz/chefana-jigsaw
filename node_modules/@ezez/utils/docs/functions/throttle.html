<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>throttle | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="throttle.html">throttle</a></li></ul>
<h1>Function throttle</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures tsd-kind-function">
<li class="tsd-signature tsd-anchor-link" id="throttle">throttle<span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type" data-tsd-kind="Type parameter">RT</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">F</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">(</span>fn<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">F</span>, time<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">[</span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-symbol">...</span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">]</span>, options<span class="tsd-signature-symbol">?: </span><a href="../interfaces/ThrottleOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">ThrottleOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../types/ThrottledFunction.html" class="tsd-signature-type" data-tsd-kind="Type alias">ThrottledFunction</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type" data-tsd-kind="Type parameter">F</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> &amp; </span><a href="../interfaces/ThrottledFunctionExtras.html" class="tsd-signature-type" data-tsd-kind="Interface">ThrottledFunctionExtras</a><a href="#throttle" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Creates a throttled function that calls given function only once every given time. Throttled function takes the same
...
Returned function also includes <code>cancel</code> property - call it to stop any planned calls (and reset the <code>time</code> array
progress) and <code>flush</code> property - call it to immediately run planned call.</p>
<p>You can provide options to specify if function should be invoked immediately on first call to throttled function
(<code>leading</code> property) and if it should be called after given time (<code>trailing</code> property).</p>
<p>If (this is default) both <code>leading</code> and <code>trailing</code> property are true then it&#39;s required to call throttled function at
least twice.</p>
</div>
...
<h4>RT</h4></li>
<li>
<h4>F<span class="tsd-signature-symbol"> extends </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">...</span>args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type" data-tsd-kind="Type parameter">RT</span><span class="tsd-signature-symbol">)</span></h4></li></ul></section>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5>fn: <span class="tsd-signature-type" data-tsd-kind="Type parameter">F</span></h5>
<div class="tsd-comment tsd-typography"><p>function to throttle</p>
</div></li>
<li>
<h5>time: <span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">[</span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-symbol">...</span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">]</span><span class="tsd-signature-symbol"> = 0</span></h5>
<div class="tsd-comment tsd-typography"><p>throttle time as number or array of numbers (min 1 element)</p>
</div></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> options: <a href="../interfaces/ThrottleOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">ThrottleOptions</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <a href="../types/ThrottledFunction.html" class="tsd-signature-type" data-tsd-kind="Type alias">ThrottledFunction</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type" data-tsd-kind="Type parameter">F</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> &amp; </span><a href="../interfaces/ThrottledFunctionExtras.html" class="tsd-signature-type" data-tsd-kind="Interface">ThrottledFunctionExtras</a></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/throttle.ts#L49">throttle.ts:49</a></li></ul></aside></li></ul></section></div>
...
<li class="current tsd-kind-function"><a href="throttle.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-64-path"></use><use href="#icon-64-text"></use></svg>throttle</a></li>
