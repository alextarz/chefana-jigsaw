<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>get | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="get.html">get</a></li></ul>
<h1>Function get</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures tsd-kind-function">
<li class="tsd-signature tsd-anchor-link" id="get">get<span class="tsd-signature-symbol">(</span>source<span class="tsd-signature-symbol">: </span><a href="../interfaces/GetSource.html" class="tsd-signature-type" data-tsd-kind="Interface">GetSource</a>, property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span>, defaultValue<span class="tsd-signature-symbol">??: </span><span class="tsd-signature-type">unknown</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">unknown</span><a href="#get" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Returns the value at given path of given object. If path is not found then default value is returned. No exceptions
...
<h3>Example</h3><p>get(object, &quot;deep.property&quot;) // equals to safe <code>object.deep.property</code></p>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">get</span><span class="hl-1">(</span><span class="hl-3">object</span><span class="hl-1">, [</span><span class="hl-7">&quot;deep&quot;</span><span class="hl-1">, </span><span class="hl-7">&quot;property&quot;</span><span class="hl-1">]) </span><span class="hl-6">// same as above</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">get</span><span class="hl-1">(</span><span class="hl-3">object</span><span class="hl-1">, </span><span class="hl-7">&quot;deep[0].property&quot;</span><span class="hl-1">)</span><br/><span class="hl-6">// equals to:</span><br/><span class="hl-3">object</span><span class="hl-1">[</span><span class="hl-7">&quot;deep[0]&quot;</span><span class="hl-1">].</span><span class="hl-3">property</span><br/><span class="hl-6">// not:</span><br/><span class="hl-3">object</span><span class="hl-1">.</span><span class="hl-3">deep</span><span class="hl-1">[</span><span class="hl-5">0</span><span class="hl-1">].</span><span class="hl-3">property</span>
</code></pre>

<h3>Example</h3><p>get(object, &quot;very.deep.property&quot;, 5)
// if object.very.deep has also <code>property</code> property then it value will be returned, even if undefined
// else <code>5</code> will be returned</p>
...
<li>
<h5>source: <a href="../interfaces/GetSource.html" class="tsd-signature-type" data-tsd-kind="Interface">GetSource</a></h5>
<div class="tsd-comment tsd-typography"><p>source object to search in</p>
</div></li>
<li>
<h5>property: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span></h5>
<div class="tsd-comment tsd-typography"><p>path to the expected value written as dot-separated property names or array
with property names. Use Array when your keys includes dots. Keys are treated literally, no parsing is done on keys.</p>
</div></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> defaultValue: <span class="tsd-signature-type">unknown</span><span class="tsd-signature-symbol"> = undefined</span></h5>
<div class="tsd-comment tsd-typography"><p>value to return if path is not found. If path is found, but the value is undefined -
...
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/get.ts#L33">get.ts:33</a></li></ul></aside></li></ul></section></div>
...
<li class="current tsd-kind-function"><a href="get.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-64-path"></use><use href="#icon-64-text"></use></svg>get</a></li>
