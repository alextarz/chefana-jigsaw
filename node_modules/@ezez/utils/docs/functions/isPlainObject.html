<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>isPlainObject | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="isPlainObject.html">isPlainObject</a></li></ul>
<h1>Function isPlainObject</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures tsd-kind-function">
<li class="tsd-signature tsd-anchor-link" id="isPlainObject">is<wbr/>Plain<wbr/>Object<span class="tsd-signature-symbol">(</span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">unknown</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><a href="#isPlainObject" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Checks if given value is a plain object. Plain object should be an object that&#39;s not an instance of anything.</p>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isPlainObject</span><span class="hl-1">({}); </span><span class="hl-6">// returns true</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isPlainObject</span><span class="hl-1">(</span><span class="hl-3">Object</span><span class="hl-1">.</span><span class="hl-2">create</span><span class="hl-1">(</span><span class="hl-0">null</span><span class="hl-1">)); </span><span class="hl-6">// returns true</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isPlainObject</span><span class="hl-1">(</span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-2">URL</span><span class="hl-1">(</span><span class="hl-7">&quot;https://ezez.dev&quot;</span><span class="hl-1">)); </span><span class="hl-6">// returns false</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isPlainObject</span><span class="hl-1">([]); </span><span class="hl-6">// returns false</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">isPlainObject</span><span class="hl-1">(</span><span class="hl-5">5</span><span class="hl-1">); </span><span class="hl-6">// returns false</span>
</code></pre>
</div>
...
<div class="tsd-comment tsd-typography"><p>value to test</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/isPlainObject.ts#L10">isPlainObject.ts:10</a></li></ul></aside></li></ul></section></div>
...
<li class="current tsd-kind-function"><a href="isPlainObject.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-64-path"></use><use href="#icon-64-text"></use></svg>is<wbr/>Plain<wbr/>Object</a></li>
