...
<li class="tsd-signature tsd-anchor-link" id="capitalize">capitalize<span class="tsd-signature-symbol">(</span>text<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, restLowercase<span class="tsd-signature-symbol">??: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><a href="#capitalize" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Capitalize the first letter of a string.</p>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">capitalize</span><span class="hl-1">(</span><span class="hl-7">&quot;hello&quot;</span><span class="hl-1">) </span><span class="hl-6">// &quot;Hello&quot;</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">capitalize</span><span class="hl-1">(</span><span class="hl-7">&quot;hello my Friend&quot;</span><span class="hl-1">, </span><span class="hl-0">true</span><span class="hl-1">) </span><span class="hl-6">// &quot;Hello my friend&quot;</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">capitalize</span><span class="hl-1">(</span><span class="hl-7">&quot;hello my Friend&quot;</span><span class="hl-1">, </span><span class="hl-0">false</span><span class="hl-1">) </span><span class="hl-6">// &quot;Hello my Friend&quot;</span>
</code></pre>
</div>
...
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> restLowercase: <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> = false</span></h5>
<div class="tsd-comment tsd-typography"><p>should the rest of the string be forced to lowercase?</p>
</div></li></ul></div>
