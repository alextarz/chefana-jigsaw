<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>occurrences | @ezez/utils - v1.9.0</title><meta name="description" content="Documentation for @ezez/utils - v1.9.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script async src="../assets/search.js" id="search-script"></script><link rel="stylesheet" href="../assets/pages.css"/></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li class="tsd-signature tsd-anchor-link" id="occurrences">occurrences<span class="tsd-signature-symbol">(</span>string<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, search<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, options<span class="tsd-signature-symbol">??: </span><a href="../interfaces/OccurencesOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">OccurencesOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><a href="#occurrences" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Count the number of occurrences of a substring in a string</p>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">occurrences</span><span class="hl-1">(</span><span class="hl-7">&quot;aaa&quot;</span><span class="hl-1">, </span><span class="hl-7">&quot;a&quot;</span><span class="hl-1">); </span><span class="hl-6">// 3</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">occurrences</span><span class="hl-1">(</span><span class="hl-7">&quot;aaaa&quot;</span><span class="hl-1">, </span><span class="hl-7">&quot;aa&quot;</span><span class="hl-1">, { </span><span class="hl-3">overlap:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1"> }); </span><span class="hl-6">// 2</span>
</code></pre>

<h3>Example</h3><pre><code class="language-ts"><span class="hl-2">occurrences</span><span class="hl-1">(</span><span class="hl-7">&quot;aaaa&quot;</span><span class="hl-1">, </span><span class="hl-7">&quot;aa&quot;</span><span class="hl-1">, { </span><span class="hl-3">overlap:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1"> }); </span><span class="hl-6">// 3</span>
</code></pre>
</div>
...
<div class="tsd-comment tsd-typography"><p>string to search in</p>
</div></li>
<li>
<h5>search: <span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>string to search for</p>
</div></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> options: <a href="../interfaces/OccurencesOptions.html" class="tsd-signature-type" data-tsd-kind="Interface">OccurencesOptions</a><span class="tsd-signature-symbol"> = {}</span></h5>
<div class="tsd-comment tsd-typography"><p>options</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">number</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/dzek69/bottom-line/blob/229736d/src/occurrences.ts#L21">occurrences.ts:21</a></li></ul></aside></li></ul></section></div>
...
<li class="current tsd-kind-function"><a href="occurrences.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-64-path"></use><use href="#icon-64-text"></use></svg>occurrences</a></li>
